...
DATA_ANY_OF_SCHEMAS = ["List[object]", "object"]
...
class Data(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Data with anyOf schemas: List[object], object. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> Data:
    ...
    def from_json(cls, json_str: str) -> Data:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Data with anyOf schemas: List[object], object. Details: " + ", ".join(error_messages))
        else:
            return instance
